...
class TanduriPage extends StatefulWidget {
  const TanduriPage({super.key});

  @override
  State<TanduriPage> createState() => _TanduriPageState();
}

class _TanduriPageState extends State<TanduriPage> {
  final List<String> price = [
    '₹ 300',
  ];

  final List<String> image = [
    'assets/chicken-tanduri.jpeg',
  ];
